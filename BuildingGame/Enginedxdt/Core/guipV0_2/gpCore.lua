...
function MOD_gpCore.init()
    ...
    buttonClass = require("Enginedxdt.Core.guipV0_2.guiElements.button")
    labelClass = require("Enginedxdt.Core.guipV0_2.guiElements.label")
    cursorYClass = require("Enginedxdt.Core.guipV0_2.guiElements.cursorY")
...
function MOD_gpCore.createCursorY(id,x,y)
    table.insert(drawList,cursorYClass.newCursorY(id,x,y))
end
